...
derive instance newtypeRequest :: Newtype (Request body) _

data Response body = ResponseString H.Status H.ResponseHeaders String
                   | ResponseStream H.Status H.ResponseHeaders body
